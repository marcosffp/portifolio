...
const ProjectStats = ({ project, labels }) => {
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/marcosffp",
      };
  ...
  const projectUrl = `https://marcosfkp.com/project/${toSlug(project.Title)}`;
  ...
  const displayFeatures = (language === 'en' && project.Features_en?.length > 0) ? project.Features_en : project.Features;
      ...
      <div className="min-h-screen bg-canvas px-[2%] sm:px-0 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
            ...
            {project.Video ? (
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl aspect-video bg-black mb-8 md:mb-16 animate-fadeIn">
                <video
                  src={project.Video}
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              <div className="space-y-6 md:space-y-10 animate-slideInLeft">
                ...
                <ProjectStats project={project} labels={t.projectDetail} />
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-sky-600/10 to-blue-600/10 hover:from-sky-600/20 hover:to-blue-600/20 text-sky-300 rounded-xl transition-all duration-300 border border-sky-500/20 hover:border-sky-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                    onClick={(e) =>
                      !handleGithubClick(project.Github) && e.preventDefault()
                    }
                  >
                    <div className="absolute inset-0 translate-y-[100%] bg-gradient-to-r from-sky-600/10 to-blue-600/10 transition-transform duration-300 group-hover:translate-y-[0%]" />
